# Math Tools: Applied Mathematical Methods
...
The `.py` files contain the utils for calculations. One can import these functions for use in other projects.

## What One Will Learn
This project challenged me to design and implement algorithms that tackled what I learned in various courses (e.g. Multivariable calculus, Linear Algebra and Differential Equations, Applied Mathematical Analysis: Vector and Complex Calculus). 
